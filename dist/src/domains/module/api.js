...
const routes = () => {
    ...
    router.get('/', (0, log_1.logRequest)({}), authentication_1.isAuthenticated, async (req, res, next) => {
        try {
    ...
    router.get('/:id', (0, log_1.logRequest)({}), authentication_1.isAuthenticated, (0, request_validate_1.validateRequest)({ schema: request_1.idSchema, isParam: true }), async (req, res, next) => {
        try {
